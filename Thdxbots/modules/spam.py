...
from Thdxbots.data import GROUP, PORMS
...
async def pspam(event):
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            await event.reply("» ʜᴇʜᴇ ᴛʜɪꜱ ɢʀᴏᴜᴩ ɪꜱ ᴩʀᴏᴛᴇᴄᴛᴇᴅ ʙy ᴛʜᴜɴɴᴅᴇʀ-ꜱᴛᴏʀᴍ...")
        else:
            try:
...
async def hang(e):
    if e.sender_id in SUDO_USERS:
        if e.chat_id in GROUP:
            await e.reply("» ʜᴇʜᴇ ᴛʜɪꜱ ɢʀᴏᴜᴩ ɪꜱ ᴩʀᴏᴛᴇᴄᴛᴇᴅ ʙy ᴛʜᴜɴɴᴅᴇʀ-ꜱᴛᴏʀᴍ..")
        else:
            try:
