...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                await e.reply("ɴᴏ ᴛʜɪꜱ ɢᴜy ɪꜱ ꜱᴛʀᴏᴍ ᴏᴡɴᴇʀ....")
            elif uid == OWNER_ID:
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            if user_id in ALTRON:
                ...
                await e.reply("» ᴛʜᴜɴᴅᴇʀ-ꜱᴛᴏʀᴍ🌪️ ʀᴇᴀᴅy ꜰᴏʀ ʀᴇᴩʟy ʀᴀɪᴅ ✅")
        except NameError:
...
async def drraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply("» ᴛʜᴜɴᴅᴇʀ-ꜱᴛᴏʀᴍ ʀᴇᴩʟy ᴅᴇᴀᴄᴛɪᴠᴀᴛᴇᴅ 🧏")
        except NameError:
