...
HELP_STRING = f"★ THUNDER𝙓𝘽𝙤𝙩𝙨 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @ST_2ST**"
...
𝗦𝗽𝗮𝗺: **ꜱᴘᴀᴍꜱ ᴀ ᴍᴇꜱꜱᴀɢᴇ.**
  1) {hl}spam <count> <message to spam> (⚡ ᴛʜᴜɴᴅᴇʀ ꜱᴛᴏʀᴍ🌪️ ɪꜱ ʀᴇᴀᴅy ɢɪᴠᴇ ᴀ ᴄᴏʀʀᴇᴄᴛ ᴍᴇꜱꜱᴀɢᴇ ᴏʀ ʀᴇᴩʟy )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Thunder Bots !! @ST_2ST", cache_time=0, alert=True)
